...
@section('admin_content')
    ...
    <div class="row-fluid sortable">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" method="post" action="{{ url('/update-manufacture',$result->manufacture_id) }}">
                @csrf
              <fieldset>
                <div class="control-group">
                  <label class="control-label" for="date01">Manufacture Name</label>
                  <div class="controls">
                    <input type="text" class="input-xlarge" name="manufacture_name" value="{{ $result->manufacture_name }}" >
                  </div>
                </div>
                <div class="control-group hidden-phone">
                  ...
                  <div class="controls">
                    <textarea class="cleditor" name="manufacture_description" rows="3"  >
                        {{ $result->manufacture_description }}
                    </textarea>
                  </div>
                </div>
                {{-- <div class="control-group hidden-phone">
